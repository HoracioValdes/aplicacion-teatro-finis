<%-- 
    Document   : index
    Created on : 31-10-2023, 15:35:19
    Author     : hvaldes
--%>
    ...
    <body>
            ...
            <div class="container">
                <div class="row mt-5 mb-5" id="caja-contenido">
                    <div class="col-7" id="caja-formulario">
                        <p>Si rendiste la Prueba de Admisión a la Escuela de Teatro, te invitamos a conocer tus resultados. Para esto, debes obtener un código y seguir las instrucciones que te detallado a continuación:</p>
                        <h2 id="titulo-instrucciones">Obtención de código</h2>
                        <p>Para iniciar la consulta de tu puntaje, debes ingresar tu rut donde se indica. Posteriormente, te enviaremos un mensaje al correo electrónico (el mismo que registraste al momento de tu inscripción a la Prueba de Admisión) con un código de validación que deberás utilizar para completar este proceso.</p>
                        <form method="post" action="insercion.do" id="form-uno">
                            <div class="mb-3">
                            ...
                            <button type="submit" id="boton-generar-codigo" name="action" class="btn btn-primary mt-3" onclick="return probandoDos();">Enviar</button>
                        </form>
                    </div>
                    <div class="col-4 offset-md-1" id="caja-botones">
                        ...
                        <p class="mt-4"><b>Ingresa a esta sección si ya tienes tu código.</b></p>
                        <form action="codigo.jsp" method="POST">  
                            <button type="submit" class="btn btn-primary">Ya tengo el código</button>
                        </form>
                    </div>
                </div>
            </div>
        ...
        <script>
                                window.onload = function () {
                                    let isValid = false;
                                    const form = document.getElementById("form-uno");
